...
module.exports = {
  ...
  setupFiles: [
    './src/themes.config.example',
    './semantic.json.example',
    './src/_site'
  ],

  regExp: {
    // used to match siteFolder variable in themes.less
  ...
  source: {
    ...
    site         : './src/_site',
    tasks        : './tasks',
    themeConfig  : './src/themes.config.example',
    themeImport  : './src/themes.less',
    themes       : './src/themes',
  ...
  settings: {
    ...
    wrench: {
      ...
      // overwrite existing files update & install (default themes / definition)
      overwrite: {
        forceDelete       : true,
      ...
      // only create files that don't exist (site themes update)
      merge: {
        forceDelete       : false,
        excludeHiddenUnix : true,
        preserveFiles     : true
